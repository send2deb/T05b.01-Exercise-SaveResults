...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SAVE_QUERY_URL_KEY = "query_url";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String SAVE_QUERY_RESULTS_KEY = "query_results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getString(SAVE_QUERY_URL_KEY));
            mSearchResultsTextView.setText(savedInstanceState.getString(SAVE_QUERY_RESULTS_KEY));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SAVE_QUERY_URL_KEY,url);
        ...
        outState.putString(SAVE_QUERY_RESULTS_KEY,result);
    }
}